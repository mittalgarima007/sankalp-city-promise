...
const LoginScreen = ({ onLogin }: LoginScreenProps) => {
  ...
  const handleSignup = () => {
    // For demo purposes, directly call onLogin
    // In real app, create account first
    onLogin();
  };
    ...
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center px-4">
      <Card className="w-full max-w-md shadow-elevated border-0 bg-gradient-card">
        <CardHeader className="text-center pb-6">
          ...
          <CardTitle className="text-2xl font-bold text-primary">Welcome to Sankalp</CardTitle>
          <p className="text-muted-foreground">Your city, your responsibility</p>
        </CardHeader>
